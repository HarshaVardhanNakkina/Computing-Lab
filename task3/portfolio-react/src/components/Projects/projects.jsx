				...
				<div className="projects-list">
					<div className="list-item">
						...
						<div className="description">
							I had been be part of couple of projects. Gained experience on
							<b> Reactjs</b>, tools like <b>Git</b>, <b>NPM</b>, <b>sass</b>
							and new JavaScript features, like <b>ES6</b> functional
							programming.
						</div>
					</div>
					<div className="list-item">
						...
						<div className="role">Front-end Developer</div>
						<div className="description">
							Part of my job was to research about <b>Vuejs</b>, implement
							re-usable components like progress-bar, date-picker etc...
						</div>
					</div>
				</div>
			</div>
